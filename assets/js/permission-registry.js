...
const registry={
  view_in:{label:"Melihat Barang Masuk",description:"Mengizinkan melihat catatan Barang Masuk.",group:"Transaksi",owner:true,admin:true,operator:true},
  ...
  view_audit:{label:"Melihat Riwayat Aktivitas",description:"Mengizinkan melihat Audit Log/catatan aktivitas dan digunakan untuk pengawasan Owner.",group:"Pengawasan & Administrasi",sensitive:true,owner:true,admin:false,operator:false},
...
const groups=["Transaksi","Timbangan","Keuangan","Data Master","Laporan & Ekspor","Pengawasan & Administrasi","Pengguna & Hak Akses","Sistem & Cadangan"];
