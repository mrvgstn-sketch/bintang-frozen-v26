...
window.BFDataModel={own,str,num,weights,marketingOf,customerGroups,supplierGroups,paymentMethod,paymentLabel,itemWeights,itemTotal,groupTotal,customerSearchText,supplierSearchText,searchCustomers:(list,q)=>search(list,q,customerSearchText),searchSuppliers:(list,q)=>search(list,q,supplierSearchText)};
})();
