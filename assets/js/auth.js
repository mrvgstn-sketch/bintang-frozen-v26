  ...
  (async function(){
    ...
    const DEFAULTS = {
      owner: {
        ...
        view_audit:true, approve_history:true, request_history:true, view_in:true, view_out:true, view_finance:true, view_note:true, view_commission:true, view_history:true, view_settings:true, edit_finance:true, view_products:true, manage_products:true, view_suppliers:true, manage_suppliers:true, view_customers:true, manage_customers:true, view_employees:true, manage_employees:true
      },
      admin: {
        ...
        view_audit:false, approve_history:false, request_history:true, view_in:true, view_out:true, view_finance:true, view_note:true, view_commission:true, view_history:true, view_settings:false, edit_finance:true, view_products:true, manage_products:true, view_suppliers:true, manage_suppliers:true, view_customers:true, manage_customers:true, view_employees:true, manage_employees:true
      },
      operator: {
        view_tally:true, add_row:true, edit_data:true, delete_data:false,
        ...
        backup:false, restore:false, manage_users:false, manage_permissions:false,
        view_audit:false, approve_history:false, request_history:true, view_in:true, view_out:true, view_finance:false, view_note:false, view_commission:false, view_history:true, view_settings:false, edit_finance:false, view_products:true, manage_products:false, view_suppliers:true, manage_suppliers:false, view_customers:true, manage_customers:false, view_employees:true, manage_employees:false
      }
    };
