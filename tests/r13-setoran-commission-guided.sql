...
select public.guided_assert((select count(*)=1 from public.bf_customer_fund_classifications where case_id=:'guided_case'::uuid and gross_amount=100000 and status='PENDING_OWNER' and source_mode='SETORAN_GUIDED'),'system-derived commission proposal');
